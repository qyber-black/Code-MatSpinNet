...
f.initialize_individual = problem.generation_method

% Function that evaluates an individual
f.evaluate_individual = problem.evaluate

% Crossover Operator
f.crossover = problem.crossover_method;

% Mutation Operatoe
f.mutation = problem.mutation_method;
